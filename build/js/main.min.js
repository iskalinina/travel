...
var _sliderHero = require("./modules/sliders/slider-hero");
var _sliderTours = require("./modules/sliders/slider-tours");
var _sliderTrainings = require("./modules/sliders/slider-trainings");
var _sliderReviews = require("./modules/sliders/slider-reviews");
var _sliderAdvantages = require("./modules/sliders/slider-advantages");
var _sliderGallery = require("./modules/sliders/slider-gallery");
var _initVideo = require("./modules/video/init-video");
require("./modules/menu/toggler.js");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _sliderHero.initSliderHero)();
  (0, _sliderTours.initSliderTours)();
  (0, _sliderTrainings.initSliderTrainings)();
  (0, _sliderReviews.initSliderReviews)();
  (0, _sliderAdvantages.initSliderAdv)();
  (0, _sliderGallery.initSliderGallery)();
...
},{"./modules/form-validate/form":3,"./modules/menu/toggler.js":9,"./modules/sliders/slider-advantages":10,"./modules/sliders/slider-gallery":11,"./modules/sliders/slider-hero":12,"./modules/sliders/slider-reviews":13,"./modules/sliders/slider-tours":14,"./modules/sliders/slider-trainings":15,"./modules/video/init-video":16,"./utils/ios-vh-fix":18}],2:[function(require,module,exports){
"use strict";
...
var menuToggler = document.querySelector('[data-button="toggle-button"]');
var mainNav = document.querySelector('[data-menu="menu"]');
var overlay = document.querySelector('[data-overlay="overlay"]');
var menuList = mainNav.querySelector('[data-list="menu-list"]');
var wrapper = document.querySelector('[data-wrapper="wrapper"]');
...
exports.initSliderAdv = initSliderAdv;
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderAdv = document.querySelector('[data-slider="advantages"]');
var buttonNext = document.querySelector('[data-button="advantages-next"]');
var buttonPrev = document.querySelector('[data-button="advantages-prev"]');
var desktop = window.matchMedia('(min-width: 1200px)');
var swiperInner;
function initSliderAdv() {
  if (sliderAdv && desktop.matches) {
    swiperInner = new _swiper.default(sliderAdv, {
      loop: true,
      slidesPerView: 'auto',
      centeredSlides: true,
      initialSlide: 2,
...
},{"../../vendor/swiper.js":19}],11:[function(require,module,exports){
"use strict";
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderGallery = document.querySelector('[data-slider="gallery"]');
var buttonNext = document.querySelector('[data-button="gallery-next"]');
var buttonPrev = document.querySelector('[data-button="gallery-prev"]');
var initSliderGallery = exports.initSliderGallery = function initSliderGallery() {
  if (sliderGallery) {
    new _swiper.default(sliderGallery, {
      navigation: {
        nextEl: buttonNext,
        prevEl: buttonPrev
      },
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderHero = document.querySelector('[data-slider="hero"]');
var paginationHero = document.querySelector('[data-pagination="hero-pagination"]');
var initSliderHero = exports.initSliderHero = function initSliderHero() {
  if (sliderHero) {
    new _swiper.default(sliderHero, {
      pagination: {
        el: paginationHero,
        clickable: true
      },
...
},{"../../vendor/swiper.js":19}],13:[function(require,module,exports){
"use strict";
...
var initSliderReviews = exports.initSliderReviews = function initSliderReviews() {
  if (sliderReviews) {
    new _swiper.default(sliderReviews, {
      slidesPerView: 'auto',
      navigation: {
        nextEl: buttonNext,
        prevEl: buttonPrev
...
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderTours = document.querySelector('[data-slider="tours"]');
var buttonNext = document.querySelector('[data-button="tours-next"]');
var buttonPrev = document.querySelector('[data-button="tours-prev"]');
var initSliderTours = exports.initSliderTours = function initSliderTours() {
  if (sliderTours) {
    new _swiper.default(sliderTours, {
      navigation: {
        nextEl: buttonNext,
        prevEl: buttonPrev
      },
...
},{"../../vendor/swiper.js":19}],15:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initSliderTrainings = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper.js"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var sliderTrainings = document.querySelector('[data-slider="trainings"]');
var buttonNext = document.querySelector('[data-button="trainings-next"]');
var buttonPrev = document.querySelector('[data-button="trainings-prev"]');
var initSliderTrainings = exports.initSliderTrainings = function initSliderTrainings() {
  if (sliderTrainings) {
    new _swiper.default(sliderTrainings, {
      navigation: {
        nextEl: buttonNext,
        prevEl: buttonPrev
      },
...
},{"../../vendor/swiper.js":19}],16:[function(require,module,exports){
"use strict";
